...
plt.legend([line1, line2, line3], ["driehoek", "zaagtand", "sinus"])
...
fig2, axes2 = plt.subplots(2, 1, True, dpi=500, num="figuur 2")
...
fig3, axes3 = plt.subplots(2, 2, dpi=500, num="figuur 3")
...
for n, color in zip(aantaltermen, colors):
    # de kwadratische fout op elk punt is het verschil van de 2 in het kwadraat
